	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right">
				<h2 style="text-align: center">Thiêm Phiếu Xét Nghiệm</h2>

				<form:form modelAttribute="phieuxetnghiemForm"
					action="Quan_ly_Phieu_Xet_Nghiem_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Mã BN:</td>
								<td><form:input class="form-control"
										placeholder="Mã Bệnh Nhân" path="maBenhNhan" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Tên BN:</td>
								<td><form:input class="form-control" path="tenBenhNhan"
										placeholder="Tên Bệnh Nhân" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Mã PXN:</td>
								<td><form:input class="form-control"
										path="maPhieuXetNghiem" placeholder="Mã Phiếu Xét Nghiệm" /></td>
							</tr>
							<tr class="form-group">
								<td class="labelname">Tên Phiếu XN:</td>
								<td><form:input class="form-control"
										path="tenPhieuXetNghiem" placeholder="Tên Phiếu Xét Nghiệm" /></td>
							</tr>
						</table>
					</div>
					<div class="col-md-6">
						<table>
							...
							<tr class="form-group">
								<td class="labelname">Ngày XN:</td>
								<td><form:input class="form-control" path="ngayXetNghiem"
										placeholder="Ngày Xét Nghiệm" /></td>
							</tr>
							<tr class="form-group">
								<td class="labelname">Kết Qủa:</td>
								<td><form:input class="form-control" path="ketQua"
										placeholder="Kết Qủa" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Ghi Chú:</td>
								<td><form:input class="form-control" path="ghiChu"
					...
					<a href="Quan_ly_Phieu_Xet_Nghiem_BACSI" class="btn btn-primary" style="position: absolute; 
					                                                            top: 262px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
