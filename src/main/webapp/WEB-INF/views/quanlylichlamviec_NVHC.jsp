					...
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								...
								<div class="col-sm-7">
									<a href="Them_lich_lam_viec_NVHC" class="btn btn-secondary"> <i
										class="fas fa-plus"></i> Thêm lịch làm việc
									</a>
						...
						<input class="form-control mr-sm-2 mb-3 mt-3" type="search" style="opacity: 1;
                                                                                           ...
                                                                                           top: 200px;
                                                                                           left: 49px;"
						placeholder="Tìm kiếm tên nhân viên" aria-label="Search">
						<!-- table -->
						<table class="table table-striped table-hover">
							...
							%>
							<tbody>
								<c:forEach var="lichLamViec" items="${lichLamViec}"
									varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${lichLamViec.hovaTen }</td>
										<td>${lichLamViec.hocHamhocVi }</td>
										<td>${lichLamViec.gioiTinh }</td>
										<td>${lichLamViec.ngaySinh }</td>
										<td>${lichLamViec.chuyenKhoa }</td>
										<td>${lichLamViec.phong }</td>
										<td>${lichLamViec.lichLamViec }</td>
