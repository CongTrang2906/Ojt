				...
				<div class="table-responsive">
					<div class="table-wrapper">
						...
						<table class="table table-striped table-hover">
							...
							%>
							<tbody>
								<c:forEach var="xemphongbenh" items="${xemphongbenh}"
									varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${xemphongbenh.maPhong }</td>
										<td>${xemphongbenh.tenPhong }</td>
										<td>${xemphongbenh.khoa }</td>
										<td>${xemphongbenh.sogiuongcuaPhong }</td>
										<td>${xemphongbenh.tinhTrangPhong }</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
