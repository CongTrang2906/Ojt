	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right">
				...
				<form:form modelAttribute="benhNhanForm"
					action="Quan_ly_benh_nhan_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Mã BN:</td>
								<td><form:input class="form-control"
										placeholder="Mã bênh nhân" path="maBenhnhan" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Tên BN:</td>
								<td><form:input class="form-control" path="tenBenhnhan"
										placeholder="Tên bênh nhân" /></td>
							</tr>
					...
					<a href="Quan_Ly_Thong_Tin_Benh_Nhan_NVHC" class="btn btn-primary" style="position: absolute; 
					                                                            top: 210px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
