...
<title>Thêm thuốc vào trong kho</title>
...
form {
	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right" style="padding: 60px 0;">
				<h2 style="text-align: center">Thêm Thuốc Vào Kho</h2>

				<form:form modelAttribute="KhoThuocForm"
					action="Quan_ly_Kho_Thuoc_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Mã Loại Thuốc:</td>
								<td><form:input class="form-control"
										placeholder="Mã Loại Thuốc" path="maLoaiThuoc" /></td>
							</tr>
					...
					<div class="col-md-6">
						<table>
							...
							<tr class="form-group">
								<td class="labelname">Số Lượng Cần Thêm:</td>
								<td><form:input class="form-control" path="soLuong"
										placeholder="Số Lượng Cần Thêm" /></td>
							</tr>
					...
					<a href="Quan_Ly_Kho_Thuoc_NVHC" class="btn btn-primary" style="position: absolute; 
					                                                            top: 163px;
																			    right: 568px;
																			    width: 150px;"
					>Trở lại</a>
