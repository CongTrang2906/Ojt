...
<head>
<meta charset="UTF-8">
<title>Thêm nhân lịch làm việc</title>
	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right">
				<h2 style="text-align: center">Thêm lịch làm việc</h2>

				<form:form modelAttribute="lichlamViecForm"
					action="Quan_ly_Lich_Lam_Viec_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Họ và Tên:</td>
								<td><form:input class="form-control"
										placeholder="Họ và Tên" path="hovaTen" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Học hàm/Học vị:</td>
								<td><form:input class="form-control" path="hocHamhocVi"
										placeholder="Học hàm/ Học vị" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Giới tính:</td>
								<td><form:input class="form-control" path="gioiTinh"
										placeholder="Giới tính" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Ngày sinh:</td>
								<td><form:input class="form-control" path="ngaySinh"
										placeholder="Ngày sinh" /></td>
							</tr>
					...
					<div class="col-md-6">
						<table>
						    <tr class="form-group">
								<td class="labelname">Chuyên khoa:</td>
								<td><form:input class="form-control" path="chuyenKhoa"
										placeholder="Chuyên khoa" /></td>
							</tr>
						    <tr class="form-group">
								<td class="labelname">Phòng:</td>
								<td><form:input class="form-control" path="phong"
										placeholder="Phòng" /></td>
							</tr>
							<tr class="form-group">
								<td class="labelname">Lịch làm việc:</td>
								<td><form:input class="form-control" path="lichLamViec"
										placeholder="Lịch làm việc" /></td>
							</tr>
					...
					<a href="Quan_ly_Lich_Lam_Viec_NVHC" class="btn btn-primary" style="position: absolute; 
					                                                            top: 265px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
