...
form {
	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right" style="padding: 53px;">
				<h2 style="text-align: center">Thêm Thuốc Mới</h2>

				<form:form modelAttribute="ThuocForm" action="Quan_ly_Thuoc_add"
					method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Mã Thuốc:</td>
								<td><form:input class="form-control" placeholder="Mã Thuốc"
										path="maThuoc" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Tên Thuốc:</td>
								<td><form:input class="form-control" path="tenThuoc"
										placeholder="Tên Thuốc" /></td>
							</tr>
							<tr class="form-group">
								<td class="labelname">Loại Thuốc:</td>
								<td><form:input class="form-control" path="loaiThuoc"
										placeholder="Loại Thuốc" /></td>
							</tr>
						</table>
					</div>
					<div class="col-md-6">
						<table>
							...
							<tr class="form-group">
								<td class="labelname">Đơn Gía:</td>
								<td><form:input class="form-control" path="donGia"
										placeholder="Đơn Gía" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Chỉ Định:</td>
								<td><form:input class="form-control" path="chiDinh"
										placeholder="Chỉ Định" /></td>
							</tr>
						</table>
					</div>
					<tr>
						...
						<td><form:button class="btn btn-primary"
								style="    position: absolute;
																			    top: 200px;
																			    right: 331px;
																			    width: 150px;">Thêm Thuốc Mới</form:button></td>
					</tr>
					<a href="Quan_Ly_Thuoc_NVHC" class="btn btn-primary" style="position: absolute; 
					                                                            top: 200px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
