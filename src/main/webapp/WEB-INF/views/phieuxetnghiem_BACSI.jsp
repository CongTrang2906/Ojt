...
<body id="top" data-spy="scroll" data-target=".navbar-collapse"
	...
	<section class="navbar navbar-default navbar-static-top"
		role="navigation" style="margin-top:-18px">
		<div class="container">
					...
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								...
								<div class="col-sm-7">
									<a href="Them_Phieu_Xet_Nghiem_BACSI" class="btn btn-secondary">
										<i class="fas fa-user-plus"></i> Thêm phiếu xét nghiệm mới
									</a>
						...
						<table class="table table-striped table-hover">
							<thead>
								<tr>
									...
									<th style="
									    width: 11%;
									">Mã phiếu xét nghiệm</th>
									<th style="
									    width: 12%;
									">Tên phiếu xét nghiệm</th>
									<th style="
										    width: 10%;
										">Ngày xét nghiệm</th>
									<th style="
							...
							%>
							<tbody>
								<c:forEach var="phieuxetnghiem" items="${phieuxetnghiem}"
									varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${phieuxetnghiem.maBenhNhan }</td>
										<td>${phieuxetnghiem.tenBenhNhan }</td>
										<td>${phieuxetnghiem.maPhieuXetNghiem }</td>
										<td>${phieuxetnghiem.tenPhieuXetNghiem }</td>
										<td>${phieuxetnghiem.ngayXetNghiem }</td>
										<td>${phieuxetnghiem.ketQua }</td>
										<td>${phieuxetnghiem.ghiChu }</td>
