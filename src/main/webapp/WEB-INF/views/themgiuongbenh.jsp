...
form {
	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right" style="padding: 65px;">
				<h2 style="text-align: center">Thêm giường mới</h2>

				<form:form modelAttribute="giuongBenhForm"
					action="Quan_ly_giuong_benh_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Mã GB:</td>
								<td><form:input class="form-control"
										placeholder="Mã giường bệnh" path="maGiuong" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Tên GB:</td>
								<td><form:input class="form-control" path="tenGiuong"
										placeholder="Tên giường bệnh" /></td>
							</tr>
					...
					<div class="col-md-6">
						<table>
							...
							<tr class="form-group">
								<td class="labelname">Tình Trạng Giường:</td>
								<td><form:input class="form-control" path="tinhTrangGiuong"
										placeholder="Tình Trạng Giường" /></td>
							</tr>
					...
					<a href="Quan_ly_giuong_Benh_NVHC" class="btn btn-primary" style="position: absolute; 
					                                                            top: 170px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
