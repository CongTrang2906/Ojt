...
<nav id="menu">
                <a href="Quan_ly_Khoa_GDBV">Quản lý khoa</a>
                <a href="Quan_ly_benh_an_GDBV">Quản lý bệnh án</a>
                <a href="Quan_ly_nhan_vien_GDBV">Quản lý nhân viên</a>
					...
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								...
								<div class="col-sm-7">
									<a href="Them_benh_an_GDBV" class="btn btn-secondary"> <i
										class="fas fa-plus"></i> Thêm bệnh án
									</a>
							...
							<tbody>
								<c:forEach var="benhan" items="${benhan}" varStatus="status">
									<tr>
										...
										<td>${benhan.tinhtrangnhapvien }</td>
										<td>${benhan.chandoanbenh }</td>
										<td>${benhan.lankham }</td>
										<td>${benhan.bacsi }</td>
