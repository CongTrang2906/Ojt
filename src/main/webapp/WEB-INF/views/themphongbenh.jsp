...
<title>Thêm phòng bệnh mới</title>
...
form {
	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right" style="padding: 60px;">
				<h2 style="text-align: center">Thêm phòng bệnh</h2>

				<form:form modelAttribute="phongBenhForm"
					action="Quan_ly_phong_benh_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Mã PB:</td>
								<td><form:input class="form-control"
										placeholder="Mã phòng bệnh" path="maPhong" /></td>
							</tr>
							<tr class="form-group">
								<td class="labelname">Tên PB:</td>
								<td><form:input class="form-control" path="tenPhong"
										placeholder="Tên phòng bệnh" /></td>
							</tr>
							</tr>
							<tr class="form-group">
								<td class="labelname">Khoa:</td>
								<td><form:input class="form-control" path="khoa"
										placeholder="Khoa" /></td>
							</tr>
						</table>
					</div>
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Số Giường Của Phòng:</td>
								<td><form:input class="form-control"
										path="sogiuongcuaPhong" placeholder="Số Giường Của Phòng" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Tình Trạng Phòng:</td>
								<td><form:input class="form-control" path="tinhTrangPhong"
										placeholder="Tình Trạng Phòng" /></td>
							</tr>
					...
					<a href="Quan_ly_Phong_Benh_NVHC" class="btn btn-primary" style="position: absolute; 
					                                                            top: 200px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
