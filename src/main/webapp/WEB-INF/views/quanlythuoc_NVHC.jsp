					...
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								...
								<div class="col-sm-7">
									<a href="Them_Thuoc_NVHC" class="btn btn-secondary"> <i
										class="fas fa-plus"></i> Thêm thuốc mới
									</a>
						...
						<input class="form-control mr-sm-2 mb-3 mt-3" type="search" style="opacity: 1;
                                                                                           ...
                                                                                           top: 200px;
                                                                                           left: 91px;"
						placeholder="Tìm kiếm tên thuốc" aria-label="Search">
						<!-- table -->
						<table class="table table-striped table-hover">
							...
							%>
							<tbody>
								<c:forEach var="thuoc" items="${thuoc}" varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${thuoc.maThuoc }</td>
