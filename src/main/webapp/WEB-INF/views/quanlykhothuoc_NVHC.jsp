...
<nav id="menu">
                ...
                <a href="Quan_Ly_Kho_Thuoc_NVHC">Kho thuốc</a>
                <a href="Quan_Ly_Thuoc_NVHC">Quản lý thuốc</a>
				<a href="Quan_Ly_Thong_Tin_Benh_Nhan_NVHC">Quản lý bệnh nhân</a>								
				<a href="Quan_ly_Phong_Benh_NVHC">Quản lý phòng bệnh</a>
				<a href="Quan_ly_giuong_Benh_NVHC">Quản lý giường bệnh</a>
				<a href="Quan_ly_Lich_Lam_Viec_NVHC">Quản lý lịch làm việc</a>
				...
				<div class="table-responsive">
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-5">
									<h2>Bảng phân loại thuốc có trong kho</h2>
								</div>
								<div class="col-sm-7">
									<a href="Them_Kho_Thuoc_NVHC" class="btn btn-secondary"> <i
										class="fas fa-plus"></i> Thêm thuốc mới vào kho
									</a>
						...
						<input class="form-control mr-sm-2 mb-3 mt-3" type="search" style="opacity: 1;
                                                                                           ...
                                                                                           top: 200px;
                                                                                           left: 91px;"
						placeholder="Tìm kiếm theo phân loại thuốc" aria-label="Search">
						<!-- table -->
						<table class="table table-striped table-hover">
							<thead>
								<tr>
									<th width="20%">STT</th>
									<th width="20%">Mã loại thuốc</th>
							...
							%>
							<tbody>
								<c:forEach var="Khothuoc" items="${Khothuoc}" varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${Khothuoc.maLoaiThuoc }   </td>
										<td>${Khothuoc.tenThuoc }</td>
										<td>${Khothuoc.loaiThuoc }</td>
										<td>${Khothuoc.soLuong }</td>
										<td style="width: 150px;"><a href="viewnhanvien.jsp"
											class="views"> <i class="far fa-eye"></i>
										</a> <a href="viewnhanvien.jsp"> <i class="far fa-edit"></i>
										</a> <a href="viewnhanvien.jsp" class="delete"> <i
