					...
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								...
								<div class="col-sm-7">
									<a href="Them_benh_nhan_NVHC" class="btn btn-secondary">
						...
						<table class="table table-striped table-hover">
							...
							<tbody>
								...
								<c:forEach var="qlttbn" items="${qlttbn}" varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${qlttbn.maBenhnhan }</td>
										<td>${qlttbn.tenBenhnhan }</td>
										<td>${qlttbn.diaChi }</td>
										<td>${qlttbn.ngaySinh }</td>
										<td>${qlttbn.gioitinh }</td>
