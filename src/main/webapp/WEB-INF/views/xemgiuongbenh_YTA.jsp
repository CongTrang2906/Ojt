				...
				<div class="table-responsive">
					<div class="table-wrapper">
						...
						<table class="table table-striped table-hover">
							...
							%>
							<tbody>
								<c:forEach var="xemgiuongbenh" items="${xemgiuongbenh}"
									varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${xemgiuongbenh.maGiuong }</td>
										<td>${xemgiuongbenh.tenGiuong }</td>
										<td>${xemgiuongbenh.cuaPhong }</td>
										<td>${xemgiuongbenh.tinhTrangGiuong}</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
