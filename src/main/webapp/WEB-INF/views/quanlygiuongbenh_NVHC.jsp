					...
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								...
								<div class="col-sm-7">
									<a href="Them_giuong_benh_NVHC" class="btn btn-secondary"> <i
										class="fas fa-plus"></i> Thêm giường mới
									</a>
						...
						<table class="table table-striped table-hover">
							...
							%>
							<tbody>
								<c:forEach var="giuongBenh" items="${giuongBenh}"
									varStatus="status">
									<tr>
										<td><%=i++%></td>
										<td>${giuongBenh.maGiuong }</td>
										<td>${giuongBenh.tenGiuong }</td>
										<td>${giuongBenh.tenPhong }</td>
										<td>${giuongBenh.tinhTrangGiuong}</td>
