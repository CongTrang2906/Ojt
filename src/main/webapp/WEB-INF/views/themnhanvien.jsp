	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right">
				...
				<form:form modelAttribute="nhanVienForm"
					action="Quan_ly_nhan_vien_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Mã NV:</td>
								<td><form:input class="form-control"
										placeholder="Mã nhân viên" path="maNhanVien" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Tên NV:</td>
								<td><form:input class="form-control" path="tenNhanVien"
										placeholder="Tên nhân viên" /></td>
							</tr>
							...
							<tr class="form-group">
								<td class="labelname">Địa Chỉ:</td>
								<td><form:input class="form-control" path="diaChi"
					...
					<div class="col-md-6">
						<table>
							<tr class="form-group">
								<td class="labelname">Số Điện Thoại:</td>
								<td><form:input class="form-control" path="soDienThoai"
							...
							<tr class="form-group">
								<td class="labelname">Chức Vụ:</td>
								<td><form:input class="form-control" path="chucVu"
										placeholder="Chức vụ" /></td>
							</tr>

							<tr class="form-group">
								<td class="labelname">Bằng Cấp:</td>
								<td><form:input class="form-control" path="bangCap"
										placeholder="Bằng cấp" /></td>
							</tr>
						</table>
					</div>
					<tr>
					...
					<a href="Quan_ly_nhan_vien_GDBV" class="btn btn-primary" style="position: absolute; 
					                                                            top: 315px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
