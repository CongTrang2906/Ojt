	...
	<div class="container register">
		<div class="row">
			...
			<div class="col-md-9 register-right">
				...
				<form:form modelAttribute="benhAnForm"
					action="Quan_ly_Benh_An_BACSI_add" method="post">
					<div class="col-md-6">
						<table>
							<tr class="form-group">
					...
					<a href="Quan_Ly_Benh_An_BACSI" class="btn btn-primary" style="position: absolute; 
					                                                            top: 217px;
																			    right: 523px;
																			    width: 150px;"
					>Trở lại</a>
